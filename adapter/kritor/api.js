...
// 假设kritor客户端唯一
export let kritorCall = null
export let kritorEventCall = null
export const waitingMap = new Map()
export const server = new grpc.Server()
const protoDir = `${_path}/plugins/Lain-plugin/adapter/kritor/kritor/protos`
const reverseProto = protoDir + '/reverse.proto'
const packageDefinition = protoLoader.loadSync(reverseProto, protoOptions)
...
server.addService(protoPackage.kritor.ReverseService.service, reverseImplementation)

const eventProto = protoDir + '/event/event.proto'
...
const eventprotoPackage = grpc.loadPackageDefinition(eventpackageDefinition)
const eventImplementation = {
  RegisterPassiveListener: (call) => {
    ...
    kritorEventCall = call
  }
}
server.addService(eventprotoPackage.kritor.event.EventService.service, eventImplementation)
...
export const api = {
   ...
   * @param {Buffer?} buf - 请求参数
   */
  async SendApi (id, cmd, buf) {
